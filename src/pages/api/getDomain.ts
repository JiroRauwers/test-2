...
const handler = (
    ...
    res.status(200).json({
        "localhost": "https://s3.sa-east-1.amazonaws.com/template.centralcorretor.com.br/content/bf18d5f9-1fb7-11ed-8aec-0259ada850d2/35fcae87-69a4-11ed-8aec-0259ada850d2/content.json",
